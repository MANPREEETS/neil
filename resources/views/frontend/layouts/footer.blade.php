	...
	<div class="preload hide">
		<img alt="" src="{{url('frontend/image/slider-oil-a.jpg')}}">
		<img alt="" src="{{url('frontend/image/slider-welding-b.jpg')}}">
		<img alt="" src="{{url('frontend/image/slider-mine-a.jpg')}}">
	</div>
	<!-- End -->
	...
	<!-- JavaScript Bundle -->
	<script src="{{url('frontend/js/jquery.bundle.js')}}"></script>
	<!-- Theme Script init() -->
